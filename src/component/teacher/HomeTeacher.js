...
{/*, color: '#1890ff' */}
        ...
        <div>
        <img style={{backgroundColor:'red', width:'100%',height:500, opacity: 0.5}}  src={require("./homestudent.jpg")} onClick={this.pri} alt="img"/>
        <div style={{position :"absolute",top:'30%',right: '45%',}}>
    <h1 style={{ fontSize:'100',fontWeight:'bold'}}>we help you </h1>
    <h1>we help you</h1>

    <Button type="dashed" htmlType="submit" className="login-form-button" 
  onClick={this.fire} style={{width:200,height:50}}> Learn more </Button>
