...
<Card className="card"   title={<h2 style={{color:'#002266',marginTop:15,fontWeight:'bold',height: 30}}>signing Up as Teacher</h2> }  style={{ width: 500,height:620 ,marginTop:30,boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2)'}}>
