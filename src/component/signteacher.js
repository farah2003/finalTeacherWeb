...
<Card className="card"   title={<h2 style={{color:'#002266',marginTop:15,fontWeight:'bold',height: 30}}>signing Up as Teacher</h2> }  style={{ width: 500,height:600 ,marginTop:30}}>
